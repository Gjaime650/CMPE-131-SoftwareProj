...
async def get_price_calendar(
    origin_sky_id: str = Query(..., description="Skyscanner city code, e.g. LOND, NYCA, SFO, PARI"),
    destination_sky_id: str = Query(..., description="Skyscanner city code, e.g. LOND, NYCA, SFO, PARI"),
...
async def get_price_history(
    ...
    departure_date: Optional[date] = Query(None, description="Flight departure date, format: YYYY-MM-DD (omit for all dates)"),
    ...
    return PriceHistoryResponse(
        ...
        airline_code=airline_code,
        snapshots=[
            PriceSnapshotSchema(departure_date=r.departure_date, recorded_at=r.recorded_at, price=r.price, currency=r.currency)
            for r in rows
        ],
